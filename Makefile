...
SRCS_DIR = srcs
SRCS_HELPERS_FILES = is/ft_isalnum.c is/ft_isalpha.c is/ft_isascii.c is/ft_isdigit.c is/ft_isprint.c is/ft_isinbase.c \
		...
		str/ft_split.c str/ft_strchr.c str/ft_strdup.c str/ft_strjoin.c str/ft_strlcat.c str/ft_strlcpy.c str/ft_strlen.c str/ft_strmapi.c str/ft_strncmp.c str/ft_strnstr.c str/ft_strrchr.c str/ft_strtrim.c str/ft_substr.c \
...
$(BUILD_DIR)/%.o: $(SRCS_DIR)/%.c $(INCLUDES) Makefile
	@mkdir -p $(@D)
	$(CC) $(C_FLAGS) -I $(INCLUDES_FOLDER) -c $< -o $@
